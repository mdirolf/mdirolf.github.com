...
The new GridFS API is available in PyMongo versions **>= 1.6**. There are "API docs":http://api.mongodb.org/python/current/api/gridfs/index.html available for the new version of GridFS, but this post walks through the API in a little more detail.
