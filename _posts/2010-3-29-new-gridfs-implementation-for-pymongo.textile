...
All that said, I think there is one place where PyMongo has been deficient for a long time: its support for "GridFS":http://dochub.mongodb.org/core/gridfs. There are a couple of problems with the GridFS implementation in previous versions (**<= 1.5.1**) of PyMongo:
